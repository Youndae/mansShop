...
<script>
    $(function () {
        ...
        if(path.startsWith('/admin/qna/product/new'))
            $('#searchActionForm').attr('action', '/admin/qna/product/new');
        else if(path.startsWith('/admin/qna/product/all'))
            $('#searchActionForm').attr('action', '/admin/qna/product/all');
    })
</script>
<body>
<div class="container">
                ...
                <table class="admin-content-table">
                    ...
                    <tbody>
                        <c:forEach items="${list.content}" var="qna">
                            ...
                            <tr class="admin-order-body-tr" onclick="productQnAListOnClick(this)" data-qna-id="${qna.qnaId}">
