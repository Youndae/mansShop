            ...
            <div class="mypage-qna-content">
                <div class="mypage-qna-content-header-btn">
                    <c:if test="${not detail.status}">
                        <button type="button" class="header-btn-modify" onclick="handleProductQnACompleteBtn(this)" value="${detail.qnaId}">답변 완료 처리</button>
                    </c:if>
                </div>
                ...
                <div class="qna-reply-input">
                    ...
                    <button class="default-btn" value="${detail.qnaId}" onclick="handleProductQnAReplySubmit(this)">작성</button>
                </div>
                        ...
                        <div class="qna-detail-reply detail-reply-${reply.replyId}">
                            ...
                            <div class="qna-reply-content">
                                ...
                                <c:if test="${reply.writer == '관리자'}">
                                    <button type="button" value="${reply.replyId}" class="default-btn" onclick="handleProductQnAReplyModifyBtn(this)">댓글 수정</button>
                                </c:if>
                            </div>
